...
Pod::Spec.new do |s|
  s.name             = 'ExposeBox'
  s.version          = '0.1.0'
  s.summary          = 'A short description of ExposeBox.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Viktor Shchepanovskyi/ExposeBox'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Viktor Shchepanovskyi' => 'viktor.shchepanovskyi@market.com' }
  s.source           = { :git => 'https://github.com/Viktor Shchepanovskyi/ExposeBox.git', :tag => s.version.to_s }
